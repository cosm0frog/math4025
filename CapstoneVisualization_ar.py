...
# -*- coding: utf-8 -*-
"""
Created on Thu Apr 11 13:48:27 2024
...
import pandas as pd
import park_formants

park_data = park_formants.get_data()
...
def graph_park(data):
    ...
    plt.legend()
    plt.savefig('park_formants_comparison.png')
