...
er_data_frame = pd.DataFrame(data)

#create an excel sheet variable and grab the amount of sheets in it
xl = pd.ExcelFile("/Users/derekchase/Desktop/capstone files/Excel books/er data workbook.xlsx")
...
for i in range(sheet_len-1):
    ...
    if f1avg and f2avg != '':
        ...
        er_data_frame.loc[len(er_data_frame)] = newline
    pd.set_option('display.max_rows', 20)
        
    er_data_frame.to_excel('ER ANALYSIS.xlsx', sheet_name='ER data frame')
...
#create an excel sheet variable and grab the amount of sheets in it
xl = pd.ExcelFile("/Users/derekchase/Desktop/capstone files/Excel books/modern er book.xlsx")
sheet_len = len(xl.sheet_names)
...
for i in range(sheet_len):
    ...
    if f1avg and f2avg != '':
        ...
        newline = {'year': yr, 'vowel': vl, 'F1/F2 dif': f1_2_dif, 'F3 dif': f3_dif}
        er_data_frame.loc[len(er_data_frame)] = newline
    er_data_frame.to_excel('MODERN ER ANALYSIS.xlsx', sheet_name='ER data frame')
